const USK_I18N = (() => {
  ...
  const STRINGS = {
    en: {
      ...
      email_hint: "User ID is generated from the email address.",
      ...
      password_hint: "Optional. If set, backups are end-to-end encrypted before upload.",
      error_cookie_size_exceeded: "Cookie payload exceeds {limit} KB limit.",
      error_password_required: "Password required for restore",
      error_invalid_password: "Invalid password",
      error_user_id_missing: "Set an email in settings to generate a user ID.",
    ...
    zh: {
      ...
      options_hint: "",
      label_email: "邮箱地址",
      email_hint: "使用邮箱地址生成用户 ID。",
      label_api_base: "后端服务地址",
      label_password: "加密密码",
      ...
      password_hint: "可选。设置后会在上传前进行端对端加密。",
      error_cookie_size_exceeded: "Cookie 总大小超过 {limit} KB 限制。",
      error_password_required: "恢复需要密码",
      error_invalid_password: "密码错误",
      error_user_id_missing: "请在设置中填写邮箱以生成用户 ID。",
      language_english: "English",
      language_chinese: "中文",
    },
  };
